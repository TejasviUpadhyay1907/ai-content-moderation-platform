...
from src.data_loaders import ModerationDataBias, ModerationDataMultilingual, ModerationDataOriginal
from torch.utils.data import DataLoader
from tqdm import tqdm
from train import ContentClassifier


def test_classifier(config, dataset, checkpoint_path, device="cuda:0"):
    model = ContentClassifier(config)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AI Content Moderation Platform")
    parser.add_argument(
        "-c",
        "--config",
        default=None,
