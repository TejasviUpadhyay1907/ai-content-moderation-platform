...
class ModerationData(Dataset):
    """Base dataloader for the Toxic Comment Classification Challenges."""
...
class ModerationDataOriginal(ModerationData):
    """Dataloader for the original Toxic Comment Classification Challenge.
    Source: https://www.kaggle.com/c/jigsaw-toxic-comment-classification-challenge
    """

    def __init__(
        self,
        train_csv_file="moderation_data/train.csv",
        test_csv_file="moderation_data/test.csv",
        train=True,
...
class ModerationDataBias(ModerationData):
    """Dataloader for the Unintended Bias in Toxicity Classification.
...
class ModerationDataMultilingual(ModerationData):
    """Dataloader for the Multilingual Toxic Comment Classification.
    Source: https://www.kaggle.com/c/jigsaw-multilingual-toxic-comment-classification/
    """

    def __init__(
        self,
        train_csv_file="moderation_data/multilingual_challenge/moderation-toxic-comment-train.csv",
        test_csv_file="moderation_data/multilingual_challenge/validation.csv",
        train=True,
        classes=["toxic"],
    ):
        self.classes = classes
